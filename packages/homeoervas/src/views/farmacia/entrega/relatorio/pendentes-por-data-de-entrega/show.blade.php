...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-4">
			<p>Exibindo entregas pendentes por data de entrega no período de {{ Carbon\Carbon::createFromFormat('Y-m-d', $request->inicio)->format('d/m/Y') }} até {{ Carbon\Carbon::createFromFormat('Y-m-d', $request->termino)->format('d/m/Y') }}</p>
		</div>
	</div>
